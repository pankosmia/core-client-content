                    ...
                    showBookFields && <>
                      <FormControl>
                        ...
                        </FormGroup>
                        {
                            showVersification &&
                              <FormControl>
                                <InputLabel id="booksVersification-label" htmlFor="booksVersification" sx={sx.inputLabel}>
                                ...
                                >
                                    {
                                        versificationCodes.map((listItem, n) => <MenuItem key={n} value={listItem} dense>
